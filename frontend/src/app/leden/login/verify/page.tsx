...
import { memberVerifyLogin } from "@/lib/api";
    ...
    return (
      <div className="max-w-sm mx-auto mt-16">
        <div className="card">
          ...
          <a href="/leden/login" className="btn-primary mt-4 inline-block">Opnieuw proberen</a>
        </div>
      </div>
    );
  }
...
export default function LedenVerifyPage() {
  return (
    <Suspense>
      <VerifyContent />
    </Suspense>
