...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-16">
      <div className="card">
        <h1 className="text-2xl font-bold text-blue-800 mb-2">Inloggen</h1>
        <p className="text-gray-600 text-sm mb-6">
          Vul je e-mailadres in. Je ontvangt een inloglink en een code. Werkt voor
          zowel leden als beheerders.
        </p>
