...
# The id is a timestamp and not a sequence number (#951). Two CLIs that pick
# "the next number" at the same time pick the same one; two that are given a
# timestamp cannot collide. The sequence number sits at the front of the FILE
# NAME, for readability and sorting — alembic does not look at it.
