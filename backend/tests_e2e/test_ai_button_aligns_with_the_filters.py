...
def test_the_ai_button_shares_its_centre_with_the_search_field(browser_pagina, scherm):
    ...
    assert abs(verschil) <= 2, (
        ...
        "Staat hij HOGER, kijk dan naar een verborgen veld vóór de controls-div: "
        "`space-y-3` geeft de eerstvolgende zichtbare broer 12 px mee. Staat hij "
        "LAGER, dan is hij tegen het formulier inclusief `mb-4` gecentreerd in "
        "plaats van tegen de regel controls (#1197).")
