...
# Diagnostiek na een UAT-deploy — bundelt in ÉÉN bestand wat je anders los
...
#
# Gebruik:  ./logging-uat.sh
# Output:   /tmp/uat-diagnostics.log  (override met LOG_OUT=..., aantal regels met LOG_TAIL=...)

ENV=uat
COMPOSE="docker-compose.uat.yml"
ENVFILE=".env.uat"
...
# deploy (deploy-uat.sh) reset de logfile bij start; dit voegt de post-deploy-
